...
class CholeskyVariationalDistributionTunableInit(CholeskyVariationalDistribution):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        covar_init = covar_init_var * torch.eye(num_inducing_points, num_inducing_points)
...
class ApproxGPModel(ApproximateGP):
    def __init__(self, x_train, q_var_init=1.0):
        N, D = x_train.size(0), x_train.size(1)
        # var_dist = CholeskyVariationalDistributionTunableInit(N, covar_init_var=q_var_init)
